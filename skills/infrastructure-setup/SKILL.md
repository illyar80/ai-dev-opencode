...
- `.opencode/skills/project-knowledge/references/architecture.md` — tech stack, framework
- `.opencode/skills/project-knowledge/references/patterns.md` — code conventions, branching strategy, testing
- `.opencode/skills/project-knowledge/references/deployment.md` — deployment strategy
