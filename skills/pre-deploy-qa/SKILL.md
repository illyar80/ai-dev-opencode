...
Write a brief entry to decisions.md following the template (`~/.shared/work-templates/decisions.md.template`). Link to `logs/working/qa-report.json` for the full report.
