...
- `.opencode/skills/project-knowledge/references/deployment.md`
- `.opencode/skills/project-knowledge/references/architecture.md`
- `.opencode/skills/project-knowledge/references/patterns.md`
    ...
    steps:
      ...
      - id: check
        run: |
          ...
          if echo "$FILES" | grep -vqE '\.(md|txt)$|^\.opencode/|^\.spec/|^docs/'; then
...
Document all required secrets in `.opencode/skills/project-knowledge/references/deployment.md`. For each secret:
