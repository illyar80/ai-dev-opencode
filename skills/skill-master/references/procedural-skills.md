...
Procedural skills guide OpenCode through a strict sequence of phases where order matters. This reference covers patterns specific to procedural skills.

## Explicit Steps + Phase Checkpoints

"Analyze appropriately" — bad. OpenCode doesn't know what specifically to do.
