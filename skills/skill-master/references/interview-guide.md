...
```bash
ls ~/.opencode/tmp/interview-skill-*.yml 2>/dev/null
```
...
cp ~/.shared/interview-templates/skill.yml ~/.opencode/tmp/interview-skill-$TIMESTAMP.yml
```
...
- Delete interview file: `rm ~/.opencode/tmp/interview-skill-*.yml`
