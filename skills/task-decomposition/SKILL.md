...
[`task-validator`](agents/task-validator.md) (explore) — Template Compliance + AC/TDD carry-forward:
...
[`reality-checker`](agents/reality-checker.md) (explore) — Reality & Adequacy:
