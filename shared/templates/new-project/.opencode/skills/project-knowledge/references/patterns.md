...
For universal coding standards, see `~/.opencode/skills/code-writing/references/universal-patterns.md`.
...
Generic testing methodology lives in ~/.opencode/skills/test-master/.
-->
